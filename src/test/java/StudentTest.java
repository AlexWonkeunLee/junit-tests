...
public class StudentTest {
    ...
    public void testIfUpdateGradeWorks(){
        ...
        newGuy.addGrade(90);
        newGuy.addGrade(100);
        assertEquals(90, newGuy.grades.get(1), 0);
        newGuy.updateGrade(90, 85);
        assertEquals(85, newGuy.grades.get(1), 0);
    }
    ...
    public void testIfDeleteGradeWorks(){
        ...
        newGuy.addGrade(90);
        newGuy.addGrade(100);
        assertEquals(3, newGuy.grades.size());
        newGuy.deleteGrade(90);
        assertEquals(2, newGuy.grades.size());
        assertNotEquals(90, newGuy.grades.get(1), 0);
        assertEquals(100, newGuy.grades.get(1), 0);
    }
}
